...
export const CARD_TEMPLATES: CardTemplate[] = [
  {
    ...
    benefits: [
      ...
      { name: 'Lululemon', description: '$75/quarter', credit_type: 'dollar', credit_amount: 75, period_type: 'quarterly', is_auto_used: false },
      { name: 'Oura Ring', description: '$200/year, hardware only', credit_type: 'dollar', credit_amount: 200, period_type: 'annual', is_auto_used: false },
      { name: 'Digital Credit', description: '$25/month', credit_type: 'dollar', credit_amount: 25, period_type: 'monthly', is_auto_used: true },
      { name: 'UberOne Subscription', description: '$9.99/month', credit_type: 'dollar', credit_amount: 9.99, period_type: 'monthly', is_auto_used: true },
      ...
      { name: 'Flight Incidentals', description: '$200/year, single airline', credit_type: 'dollar', credit_amount: 200, period_type: 'annual', is_auto_used: false },
      { name: 'CLEAR', description: '$189 per year', credit_type: 'dollar', credit_amount: 189, period_type: 'annual', is_auto_used: true },
      ...
      { name: 'Global Entry / TSA Precheck', description: 'Resets every 4 years, not annually', credit_type: 'dollar', credit_amount: 120, period_type: 'annual', is_auto_used: false },
      { name: 'Walmart+ Membership', description: '$14 per month', credit_type: 'dollar', credit_amount: 14, period_type: 'monthly', is_auto_used: true },
  ...
  },
  {
    ...
    benefits: [
      ...
      { name: 'Dunkin Donuts', description: '$7/month', credit_type: 'dollar', credit_amount: 7, period_type: 'monthly', is_auto_used: false },
      { name: 'Resy Restaurants', description: '$50/half year', credit_type: 'dollar', credit_amount: 50, period_type: 'semi_annual', is_auto_used: false },
      { name: 'Dining Credit', description: '$10/month for GrubHub, Five Guys, etc', credit_type: 'dollar', credit_amount: 10, period_type: 'monthly', is_auto_used: false },
  ...
  },
  {
    ...
    benefits: [
      ...
      { name: 'Resort Credit', description: '$200/half year', credit_type: 'dollar', credit_amount: 200, period_type: 'semi_annual', is_auto_used: false },
    ],
  },
  {
    key: 'world_of_hyatt',
  ...
  },
  {
    ...
    benefits: [
      { name: 'Capital One Travel Credit', description: '$300/year, bookings via Capital One Travel', credit_type: 'dollar', credit_amount: 300, period_type: 'annual', is_auto_used: false },
      { name: 'Global Entry / TSA Precheck', description: 'Resets every 4 years, not annually', credit_type: 'dollar', credit_amount: 120, period_type: 'annual', is_auto_used: false },
    ],
  },
  {
    ...
    benefits: [
      { name: 'Companion Certificate', description: 'Companion on round-trip flight within U.S. and to Mexico, Caribbean, or Central America', credit_type: 'perk', credit_amount: 0, period_type: 'annual', is_auto_used: false },
      { name: 'Resy Restaurants', description: '$20/month on eligible Resy restaurants', credit_type: 'dollar', credit_amount: 20, period_type: 'monthly', is_auto_used: false },
      { name: 'Delta Sky Club Access', description: '15 visits each Medallion Year to the Delta Sky Club when flying Delta', credit_type: 'perk', credit_amount: 15, period_type: 'annual', is_auto_used: false },
      { name: 'Rideshare', description: '$10/month on U.S. rideshare purchases', credit_type: 'dollar', credit_amount: 10, period_type: 'monthly', is_auto_used: false },
      { name: 'Delta Stays', description: '$200/year on prepaid hotel or vacation rental through Delta Stays', credit_type: 'dollar', credit_amount: 200, period_type: 'annual', is_auto_used: false },
    ],
  },
  {
    ...
    benefits: [
      { name: 'Delta Flight Credit', description: '$200/year after spending $10K', credit_type: 'dollar', credit_amount: 200, period_type: 'annual', is_auto_used: false },
      { name: 'Rideshare', description: '$10/month on U.S. rideshare purchases', credit_type: 'dollar', credit_amount: 10, period_type: 'monthly', is_auto_used: false },
      { name: 'Delta Stays', description: '$100/year on prepaid hotel or vacation rental through Delta Stays', credit_type: 'dollar', credit_amount: 100, period_type: 'annual', is_auto_used: false },
    ],
  },
  {
    key: 'bilt_palladium',
    ...
    benefits: [
      { name: 'Bilt Travel Portal Hotel Credit', description: '$200/half year', credit_type: 'dollar', credit_amount: 200, period_type: 'semi_annual', is_auto_used: false },
    ],
  }
];
